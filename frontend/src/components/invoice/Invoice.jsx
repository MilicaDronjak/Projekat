...
const Invoice = () => {
    ...
    const {shippingInfo, orderItems, paymentInfo, totalAmount, orderStatus} = order
      ...
      <div id="order_invoice" className="p-3 border border-secondary">
        <header className="clearfix">
          ...
          <div id="company" className="clearfix">
            ...
            <div>
              <a href="mailto:info@shopit.com">info@mobileShop.com</a>
            </div>
          </div>
          <div id="project">
            <div><span>Name</span> {authUser?.name}</div>
            <div><span>EMAIL</span> {authUser?.email}</div>
